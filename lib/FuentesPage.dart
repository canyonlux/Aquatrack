      ...
      body: FutureBuilder(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasError) {
            return Center(child: Text('Ha ocurrido un error', style: TextStyle(color: Color(0xFF333333)))); // Estilo para el texto de error
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                return Card(
                  ...
                  child: ListTile(
                    leading: Icon(Icons.water_drop, color: Color(0xFF0077B6)), // Icono personalizado
                    title: Text(
                      data[index].municipio,
                      style: TextStyle(color: Color(0xFF333333), fontWeight: FontWeight.bold), // Estilo para el título
                    ),
                    subtitle: Text(
                      data[index].estado,
                      style: TextStyle(color: Color(0xFF00B4D8)), // Estilo para el subtítulo
                    ),
                    onTap: () {
                      Navigator.push(
                        context,
            ...
            return Center(child: CircularProgressIndicator(color: Color(0xFF0077B6))); // Circular Progress Indicator con color personalizado
          }
        },
      ),
